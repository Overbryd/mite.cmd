...
The configure command also tries to install the bash auto completion hook into the following files: @~/.bash_completion@, @~/.bash_login@, @~/.bashrc@.

If your system doesn't support one of the file above, install the hook by yourself.
